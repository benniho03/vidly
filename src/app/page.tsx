    ...
    <div>
      ...
      <div className="container mx-auto px-20 ">
        <div className="background mb-0">
          ...
          <h2>KNOWN TO ALL</h2>
          <h2>FEARED BY MANY</h2>
          <h2>UNDERSTOOD BY NONE</h2>
          ...
          <div className="keyfacts">
            <div className="number-facts grid grid-cols-3 gap-4">
              ...
              <div className="number-facts-item">
                ...
                <p className='content-small'>of video per day</p>
              </div>
              <div className="number-facts-item">
                <p className="content">${formatNumber(300000000)}</p>
                <p className='content-small'>were generated in advertising revenue from all of YouTube combined in 2021</p>
              </div>
            </div>
          </div>
        </div>
